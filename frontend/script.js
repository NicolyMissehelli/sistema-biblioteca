...
function updateStats(){
 $("#statBooks").textContent=books.reduce((s,b)=>s+b.qty,0);
 $("#statAvailable").textContent=books.reduce((s,b)=>s+b.available,0);
 $("#statStudents").textContent=students.length;
 $("#statLoans").textContent=books.reduce((s,b)=>s+(b.qty-b.available),0);
}
...
updateStats();renderBooks();renderStudents();
